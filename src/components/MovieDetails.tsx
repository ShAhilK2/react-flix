  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      {showPlayer && trailer && (
        <div className="fixed inset-0 z-[9999] bg-black">
          ...
          <button
            ...
            className="absolute top-20 right-4 bg-white/90 text-black px-6 py-3 rounded-lg hover:bg-white transition-colors font-semibold shadow-lg z-10"
          >
            ✕ Close
          </button>
        </div>
              ...
              <div className="container mx-auto px-6 pb-12">
                <div className="flex flex-col md:flex-row gap-8 items-end">
                  ...
                  <div className="flex-1 pb-4">
                    ...
                    {movie.tagline && (
                      <p className="text-gray-200 text-lg md:text-xl italic mb-6 drop-shadow-md">
                        "{movie.tagline}"
                      </p>
                    )}
                    ...
                    {trailer && (
                      <button
                        ...
                        className="flex items-center gap-3 bg-white text-black px-8 py-4 rounded-lg font-bold text-lg hover:bg-gray-200 transition-all transform hover:scale-105 shadow-xl"
                      >
      ...
      {videos && videos.length > 0 && !showPlayer && (
        <div className="container mx-auto px-6 pb-12">
          <h2 className="text-3xl font-bold mb-6">Videos & Clips</h2>
